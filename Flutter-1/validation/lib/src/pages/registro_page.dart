...
import 'package:validation/src/providers/usuario_provider.dart';
import 'package:validation/src/utils/utils.dart';
...
final cirulo=Container(
  ...
  return Stack(
    children: <Widget>[
      ...
      Positioned(top: -40.0,right: -30.0,child: cirulo),
      Positioned(bottom: -50.0,right: -10.0,child: cirulo),
      Positioned(bottom: 120.0,right:20.0,child: cirulo),
      Positioned(bottom:-50.0,left: 30.0,child: cirulo),
      Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            Text('YO ROBOT', style:TextStyle(color: Colors.white, fontSize: 25.0))
          ],
        ),
      )
